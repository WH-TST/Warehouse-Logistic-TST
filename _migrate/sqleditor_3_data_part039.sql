...
INSERT INTO "public"."wh_eval_skills" VALUES
...
INSERT INTO "public"."wh_evaluations" VALUES
	('0b5849af-e810-4998-9571-d983bc33f410', '60059', 'MR.MYO WIN HTUT ( มูดิ )', 'lead', '2026-07', 14300, '["crane_ops", "wms_entry", "stock_count", "prod_check", "zone_arr", "team_assign", "zone_assign", "recv_dec", "del_coord", "stock_coord", "bc_id"]', 70, 'fair', NULL, '2026-07-08 12:58:34.278792+00'),
	('6264f9be-263c-46c9-bc84-cc195ef7d6f1', '60037', 'MR. PHOE THAN (หม่องเต็ง )', 'checker', '2026-07', 14250, '["crane_ops", "stock_count", "prod_check", "zone_arr"]', 57, 'overpaid', NULL, '2026-07-08 13:00:11.495498+00'),
	('f13af336-f401-40a0-8906-55406bef2da2', '62007', 'MR.KHIN MAUNG HTWE (หม่องเท)', 'checker', '2026-07', 13800, '["crane_ops", "wms_entry", "prod_check", "zone_arr", "del_coord"]', 64, 'overpaid', NULL, '2026-07-08 13:01:36.072399+00'),
	('b0b3abbe-7f73-4444-a1c8-7c01b186d022', '66017', 'MR.WAI YAN (เวยาน)', 'checker', '2026-07', 12000, '["crane_ops", "stock_count", "prod_check", "zone_arr", "equip_care"]', 64, 'fair', NULL, '2026-07-08 13:02:36.766866+00'),
	('4988769e-13fa-4ec3-9b3d-8fb9543159fa', '61071', 'MR.KYAW KYAW NAING (จอนาย)', 'checker', '2026-07', 12000, '["crane_ops", "wms_entry", "prod_check", "zone_arr", "issue_rpt", "del_coord"]', 79, 'fair', NULL, '2026-07-08 13:07:18.295462+00');
...
INSERT INTO "public"."wms_users" VALUES
	('66001', 'b5fa31b', 'น.ส.กุสุมา จันทะคุณ', 'เจ้าหน้าที่จัดส่ง', false, '{logistic-plan,customers,loading-order,loading,truck-dispatch,driver-monitor,driver-analytics,production-block}', true, '2026-06-18 02:33:54.082632+00', '2026-08-07 04:15:07.751+00', true),
	('68023', 'd9c1836d', 'น.ส.ณัฐิดา ดวงจันทร์', 'เจ้าหน้าที่จัดส่ง', false, '{logistic-plan,customers,loading-order,loading,truck-dispatch,driver-monitor,driver-analytics,production-block}', true, '2026-06-20 02:15:56.080123+00', '2026-08-07 04:15:12.917+00', true),
	('58035', '884c2f07', 'น.ส.จินตนา แสนหยอด', 'เจ้าหน้าที่คลังสินค้า', false, '{products,stock-count,kpi-stock,kpi-wh,production-block}', true, '2026-06-18 02:26:49.233804+00', '2026-08-07 04:15:19.8+00', false),
	('63012', '7097eb3a', 'นายจักรินทร์ สมบูรณ์', 'หัวหน้าแผนกคลังสินค้า', false, '{wm-manage,products,stock-count,printtag,analytics,whactivity,kpi-stock,logistic-plan,truck-dispatch,driver-monitor,driver-analytics,kpi-wh,training,user-accounts,audit-log}', true, '2026-06-18 07:20:30.64828+00', '2026-06-23 07:25:56.277+00', false),
	('p.pakkanun', '9919aa9c', 'ภคนันท์', 'พงศ์พรพรต', false, '{wm-manage,products,stock-count,printtag,analytics,whactivity,kpi-stock,logistic-plan,loading-order,loading,truck-dispatch,driver-monitor,driver-analytics,kpi-wh,user-accounts,audit-log}', true, '2026-06-20 04:43:52.964691+00', '2026-06-24 13:19:38.191+00', false),
	('Admin26052540', '776e136b', 'ผู้ดูแลระบบ', 'Administrator', true, '{input,printtag,analytics,overdue,whactivity,warehouse-map,logistic-plan,truck-dispatch,kpi-wh,kpi-stock}', true, '2026-06-18 02:01:15.902923+00', '2026-06-18 02:01:15.813+00', true);
...
INSERT INTO "public"."zone_stock" VALUES
...
--
-- Name: counting_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."counting_id_seq"', 7067, true);


--
-- Name: damage_requests_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."damage_requests_id_seq"', 1, true);


--
-- Name: delivery_confirmations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."delivery_confirmations_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."delivery_items_id_seq"', 4328633, true);


--
-- Name: driver_activity_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."driver_activity_log_id_seq"', 741, true);


--
-- Name: driver_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."driver_users_id_seq"', 9, true);


--
-- Name: driver_work_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."driver_work_logs_id_seq"', 1, false);


--
-- Name: gps_activity_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."gps_activity_log_id_seq"', 638, true);


--
-- Name: kpi_wh_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."kpi_wh_log_id_seq"', 170, true);


--
-- Name: onhand_rm_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."onhand_rm_id_seq"', 18917, true);


--
-- Name: print_tag_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."print_tag_log_id_seq"', 826, true);


--
-- Name: production_block_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."production_block_id_seq"', 1, false);


--
-- Name: semi_fg_mapping_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."semi_fg_mapping_id_seq"', 139, true);


--
-- Name: sheet_plan_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."sheet_plan_id_seq"', 1, false);


--
-- Name: shop_visits_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."shop_visits_id_seq"', 209, true);
...
SELECT pg_catalog.setval('"public"."stock_count_items_id_seq"', 20608, true);


--
-- Name: stock_count_semi_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."stock_count_semi_id_seq"', 15276, true);
...
SELECT pg_catalog.setval('"public"."stock_count_sessions_id_seq"', 782, true);


--
-- Name: training_participants_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."training_participants_id_seq"', 29, true);
...
SELECT pg_catalog.setval('"public"."training_sessions_id_seq"', 6, true);


--
-- Name: transection_fg_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."transection_fg_id_seq"', 41304, true);


--
-- Name: transection_semi_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."transection_semi_id_seq"', 5941, true);


--
-- Name: truck_inspections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."truck_inspections_id_seq"', 138, true);


--
-- Name: wh_activity_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('"public"."wh_activity_log_id_seq"', 3995, true);
