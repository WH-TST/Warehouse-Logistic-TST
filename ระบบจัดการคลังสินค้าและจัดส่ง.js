...
function _handleApiPost(e) {
  try {
    ...
    var allowedActions = [
      ...
      'getLogisticMasterData','calcRouteDistance','saveLogisticPlan','saveBatchLogisticPlans','getReadyToShipOrders',
...
function getReadyToShipOrders(shipDateStr) {
  try {
    ...
    var iQty         = colIdx['w/order']         !== undefined ? colIdx['w/order']         : 27;
